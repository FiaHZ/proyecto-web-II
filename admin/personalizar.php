...
<head>
    ...
    <link rel="stylesheet" href="../proyecto-web-II/css/personalizar.css">
</head>
<body>
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                <div class="p-4">
                    <div class="text-center mb-4">
                        <img src="../img/<?= $configuraciones['icono_principal'] ?>" alt="Logo" class="img-fluid mb-2" style="max-height: 50px;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Actual: 
                                    <img src="../img/<?= $configuraciones['icono_principal'] ?>" alt="Icono actual" class="preview-image ms-2">
                                </small>
                            </div>
                            <div class="col-md-6">

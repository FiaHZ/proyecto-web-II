...
$where_conditions = ["tipo = 'venta'", "estado = 'disponible'"];
$params = [];
$types = "";
...
$categorias_query = "SELECT DISTINCT categoria FROM propiedades WHERE tipo = 'venta' AND estado = 'disponible' ORDER BY categoria";
$categorias_result = $conn->query($categorias_query);

$ubicaciones_query = "SELECT DISTINCT ubicacion FROM propiedades WHERE tipo = 'venta' AND estado = 'disponible' ORDER BY ubicacion";
$ubicaciones_result = $conn->query($ubicaciones_query);

// Obtener estadísticas de precios para el rango
$stats_query = "SELECT MIN(precio) as min_precio, MAX(precio) as max_precio, AVG(precio) as promedio_precio FROM propiedades WHERE tipo = 'venta' AND estado = 'disponible'";
...
<head>
    ...
    <title>Propiedades en Venta - Solutions Real Estate</title>
...
<body>
    ...
    <div class="container-fluid bg-success text-white py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1><i class="bi bi-house-check me-2"></i>Propiedades en Venta</h1>
                    <p class="lead">Encuentra tu hogar ideal con las mejores opciones de compra</p>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-6">
    ...
    <div class="container my-5">
        ...
        <div class="card mb-4">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="bi bi-funnel me-2"></i>Filtrar Propiedades en Venta</h5>
            </div>
            <div class="card-body">
                ...
                <div class="col-12">
                    <div class="card text-center">
                        <div class="card-body py-5">
                            ...
                            <h4 class="mt-3">No se encontraron propiedades en venta</h4>
                            <p class="text-muted">Intenta ajustar los filtros de búsqueda o revisa más tarde</p>
                            <a href="ventas.php" class="btn btn-success">Ver todas las propiedades en venta</a>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
